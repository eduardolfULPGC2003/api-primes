...
public class Server3 implements Server{
    ...
    public Server3(String path_primes, String path_non_primes, Integer port, List<Integer> servers) {
        this.port = port;
    ...
    public static void main(String[] args) throws IOException {
        ...
        servers.add(4567);servers.add(4568);
        Server3 server = new Server3("files/primes/primes1.csv",
                "files/non-primes/non-primes1.csv", 4569, servers);
    }
}
