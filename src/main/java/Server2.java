...
public class Server2 implements Server{
    ...
    public Server2(String path_primes, String path_non_primes, Integer port, List<Integer> servers) {
        this.port = port;
    ...
    public static void main(String[] args) throws IOException {
        ...
        servers.add(4567);servers.add(4569);
        Server2 server = new Server2("files/primes/primes1.csv",
                "files/non-primes/non-primes1.csv", 4568, servers);
    }
}
